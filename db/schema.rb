...
ActiveRecord::Schema[7.0].define(version: 2023_03_08_232853) do
  ...
  create_table "activities_groups", id: false, force: :cascade do |t|
    ...
    t.bigint "group_id"
    t.index ["activity_id", "group_id"], name: "index_activities_groups_on_activity_id_and_group_id", unique: true
